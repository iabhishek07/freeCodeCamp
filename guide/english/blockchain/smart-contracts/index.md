...
A chaincode is used by administrators for grouping smart contracts for deployment, but can also be used for low-level system programming of a Hyperledger Fabric blockchain.
